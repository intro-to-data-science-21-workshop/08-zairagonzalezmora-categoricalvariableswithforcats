...
As you can see from the base R `as.factor()` function showed below, the factor may have been created, but the levels within it are listed alphabetically. This is not particularly useful if you want to have the days of the week in order.
